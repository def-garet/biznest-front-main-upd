    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.sliderWrapper}>
          ...
          {/* AR Trigger Button */}
          <TouchableOpacity 
            style={styles.arTrigger}
            onPress={() => setIsArVisible(true)}
            activeOpacity={0.8}
          >
            <View style={styles.arIconBlur}>
              <MaterialIcons name="view-in-ar" size={24} color="#FFF" />
              <Text style={styles.arTriggerText}>View in Room</Text>
            </View>
          </TouchableOpacity>
      ...
      <Modal
        ...
        animationType="slide"
        transparent={false}
        onRequestClose={() => setIsArVisible(false)}
      >
        <View style={styles.arContainer}>
          {/* Mock Camera Background - In real app, use Camera from expo-camera */}
          <Image 
            source={{ uri: 'https://images.unsplash.com/photo-1595846519845-68e298c2edd8?w=800&q=80' }} // Living room background
          ...
          <View style={styles.arOverlay}>
            <View style={styles.arHeader}>
              <TouchableOpacity style={styles.arCloseBtn} onPress={() => setIsArVisible(false)}>
            ...
            <View style={styles.arProductContainer}>
              <Image 
                source={{ uri: productDetails?.img || productDetails?.images?.[0] }} 
                style={styles.arProductImage}
                resizeMode="contain"
              />
              <View style={styles.arGuide}>
                <MaterialIcons name="gesture-pinch" size={24} color="#FFF" />
                <Text style={styles.arGuideText}>Pinch to resize • Drag to move</Text>
              </View>
            </View>

            <TouchableOpacity style={styles.arPlaceBtn} onPress={() => setIsArVisible(false)}>
              <Text style={styles.arPlaceText}>Place Item</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
...
const styles = StyleSheet.create({
  ...
  arIconBlur: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(23, 45, 85, 0.9)', // Primary Color with opacity
    paddingVertical: 10,
  ...
  arBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(23, 45, 85, 0.8)',
